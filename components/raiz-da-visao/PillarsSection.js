      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-20 relative">
          ...
          <motion.div
            ...
            className=""
          >
            <a href="/alagbara" className="flex flex-col items-center text-center p-8 bg-stone-900/20 rounded-2xl border border-stone-800/30 shadow-[0_0_40px_rgba(0,0,0,0.3)]">
          ...
          >
            <a href="/aseagba" className="flex flex-col items-center text-center p-8 bg-stone-900/20 rounded-2xl border border-stone-800/30 shadow-[0_0_40px_rgba(0,0,0,0.3)]">
